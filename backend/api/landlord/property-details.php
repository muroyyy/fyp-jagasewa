...
try {
    ...
    // Get property details with tenant count (using read replica)
    $query = "SELECT p.*,
    ...
    // Get recent tenants for this property (using read replica)
