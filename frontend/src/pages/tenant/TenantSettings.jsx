...
export default function TenantSettings() {
  ...
  const fetchProfile = async () => {
    try {
      ...
      const response = await fetch('http://localhost:8000/api/tenant/profile.php', {
        method: 'GET',
        headers: {
...
function ProfileTab({ profile, setError, setSuccess, onProfileUpdate }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:8000/api/tenant/update-profile.php', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`
        },
...
function SecurityTab({ setError, setSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:8000/api/tenant/change-password.php', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
